...
const PaymentRequestView = () => {
     ...
     * @type {{url: *}}
     */
    let url = {url: t('hostStatefulPaymentUrl') + '/0'};
            ...
            <div className="row clearfix">
                <div className="col-sm-12">
                    <div className="text--center">
                        <h2 className="heading--title">{t('paymentValidation')}</h2>
                        <br/>
                        <b id='msg'></b>
                                ...
                                <div className="container">
                                    <div className="collapse navbar-collapse pull-right" id="navbar-collapse-1">
                                        <ul className="nav navbar-nav nav-pos-right navbar-left">
                                            ...
                                            <li ><a href={t('protectedUrl') + t('clientProductDeliveryUrl')}  className="menu-item"><i
                        ...
                        <div className="cart-table table-responsive bg-white" style={{padding: "35px"}}>
                            <table id="data-table" className="table table-bordered"
                                ...
                                <tr className="cart-product">
                                    ...
                                    <th className="cart-product-price">{t('coupon')}</th>
                                    ...
                                    payments.map((payment, index) => {
                                        return (
                                            <tr className="cart-product" key={payment._id} id={payment._id}>
                                                ...
                                                <td>
                                                    <a className="btn btn--primary" href={t('protectedUrl') + t('clientPaymentRequestUrl') + '/' + encode(payment._id)}><i
                                                        className='fa fa-paypal'></i> {t('validateP')}</a>
                                                </td>
                                            </tr>
                                        )
                                    })
